...
namespace GradeBook.UserInterfaces
{
    public static class StartingUserInterface
    {
        ...
        public static void CreateCommand(string command)
        {
            ...
            {
                gradeBook = new StandardGradeBook(name, parts[2].Equals("standard"));

            }
            else if (parts[2].Equals("ranked"))
            {
                gradeBook = new RankedGradeBook(name, parts[2].Equals("ranked"));

            }
            else
            {
                System.Console.WriteLine($" {parts[2]} is not a supported type of gradebook, please try again");
                return;
            }
